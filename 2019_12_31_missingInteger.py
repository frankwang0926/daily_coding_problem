...
def firstMissingPositiveInteger1(arr):
    i = 1
    while True:
        if i not in arr:
            return i
...
def firstMissingPositiveInteger2(arr):
    s = set(arr)
    i = 1
    while i in s: 
        i += 1
...
print(firstMissingPositiveInteger1([3,4,-1,1]))
print(firstMissingPositiveInteger1([1,2,0]))